...
├── diffusion_model_dependencies/ # contains scripts and modules to train, evaluate, and sample from score-based diffusion models. 

├── experiments_toy_datasets/ # geodesics under different metrics for the toy datasets (circle, s-curve, swiss-roll (spiral), ucg, wcg, and two moons) 
...
├── tutorial.ipynb # a small notebook to optimize geodesics under different Riemannian metrics on the toy datasets
